    ...
    function mul_edit() {
        ...
        $('input[type="checkbox"]').each(function(index,element) {
            if ($(element).attr('checked') == 'checked') {
                ...
                var cur_ip = $(element).parent().siblings().children('.ip').text();
                ...
                $(element).parent().siblings().children('.ip').replaceWith('<input class="ip"  type="text" value=' + cur_ip + '>');
